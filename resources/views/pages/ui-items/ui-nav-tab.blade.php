                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-widget="navbar-search"
                                                        data-target="#navbar-search1" href="#" role="button">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <nav class="navbar navbar-expand navbar-white navbar-light">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-widget="navbar-search"
                                                        data-target="#navbar-search2" href="#" role="button">
                                                        <i class="fas fa-search"></i>
                                                    </a>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <h4 class="mt-4">Primary Navbar <small><b>recommended</b> (navbar-primary
                                        ...
                                        <nav class="navbar navbar-expand navbar-primary navbar-dark">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-widget="navbar-search"
                                                        data-target="#navbar-search3" href="#" role="button">
                                                        <i class="fas fa-search"></i>
                                                    </a>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <nav class="navbar navbar-expand navbar-primary navbar-light">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-widget="navbar-search"
                                                        data-target="#navbar-search4" href="#" role="button">
                                                        <i class="fas fa-search"></i>
                                                    </a>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <h4 class="mt-4">Orange Navbar <small><b>recommended</b> (navbar-orange
                                        ...
                                        <nav class="navbar navbar-expand navbar-orange navbar-light">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-widget="navbar-search"
                                                        data-target="#navbar-search5" href="#" role="button">
                                                        <i class="fas fa-search"></i>
                                                    </a>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <nav class="navbar navbar-expand navbar-orange navbar-dark">
                                            ...
                                            <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-widget="navbar-search"
                                                        data-target="#navbar-search6" href="#" role="button">
                                                        <i class="fas fa-search"></i>
                                                    </a>
                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill"
                                            ...
                                            aria-controls="custom-tabs-two-home" aria-selected="true">Home</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="col-5 col-sm-3">
                                <div class="nav flex-column nav-tabs nav-tabs-right h-100" id="vert-tabs-right-tab"
                                    ...
                                    <a class="nav-link active" id="vert-tabs-right-home-tab" data-toggle="pill"
                                        href="#vert-tabs-right-home" role="tab"
                                        aria-controls="vert-tabs-right-home" aria-selected="true">Home</a>
